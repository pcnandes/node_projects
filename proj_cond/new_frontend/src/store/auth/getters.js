...
export function getExpiracaoToken (state) {
  return state.expiracaoToken ? new Date(state.expiracaoToken) : state.expiracaoToken
}

export function getCondominioLogin (state) {
  return state.condominioLogin
}

export function getBlocoLogin (state) {
  return state.blocoLogin
}
